...
const liveUsers = [
  { id: 1, photoURL: null as string | null, name: 'דני', nameEn: 'Danny', isActive: true, activity: 'ריצה', activityEn: 'Running', icon: '👟', duration: '23 דק׳', mapPos: { top: '20%', right: '55%' }, color: 'from-orange-500 to-red-500' },
  { id: 2, photoURL: null as string | null, name: 'שרה', nameEn: 'Sarah', isActive: true, activity: 'רכיבה', activityEn: 'Cycling', icon: '🚴', duration: '45 דק׳', mapPos: { top: '45%', right: '25%' }, color: 'from-cyan-500 to-blue-500' },
  { id: 3, photoURL: null as string | null, name: 'יוסי', nameEn: 'Yossi', isActive: true, activity: 'כושר', activityEn: 'Gym', icon: '🏋️', duration: '18 דק׳', mapPos: { top: '60%', right: '70%' }, color: 'from-purple-500 to-pink-500' },
  { id: 4, photoURL: null as string | null, name: 'נועה', nameEn: 'Noa', isActive: false, activity: 'לא פעיל', activityEn: 'Offline', icon: '💤', duration: '-', mapPos: { top: '35%', right: '12%' }, color: '' }
];
          ...
          >
            {user.isActive ? (
              <div className="relative">
                ...
                <div className={`relative w-14 h-14 bg-gradient-to-br ${user.color} rounded-full p-0.5 shadow-xl flex items-center justify-center`}>
                  <UserAvatar photoURL={user.photoURL} displayName={user.name} size={52} />
                </div>
                ...
                {selectedUser === user.id && (
                  ...
                  >
                    <div className="flex items-start gap-3 mb-3">
                      <UserAvatar photoURL={user.photoURL} displayName={user.name} size={48} />
              ...
              <div className="relative opacity-40">
                <div className={`w-14 h-14 rounded-full p-0.5 shadow-md ${dark ? 'bg-gray-700' : 'bg-gray-300'} flex items-center justify-center`}>
                  <UserAvatar photoURL={user.photoURL} displayName={user.name} size={52} className="grayscale" />
                </div>
